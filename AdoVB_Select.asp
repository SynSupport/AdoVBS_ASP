...
* -----------------------------------------------------------------------     
*                                                                             
* Source:     AdoVB_Select.asp
*                                                                             
* Facility:   Example for using Microsoft Universal Data Access components 
*				from an ASP page using VBScript             
*                                                                             
* Abstract:   Returns in_itemid, in_name, in_price from the plants
*               sample database, populating a table with the result-set
*                                                                             
...
-->
<HEAD>
    <TITLE>Simple ADO Query with ASP Using VBScript</TITLE>
<%
...
sub execute_rs
    ...
    Set oRs = oConn.Execute("SELECT in_itemid, in_name, in_price FROM plants")
    CheckADOError oConn,status
    if (status <> 0) then 
